...
export class AStarGraph
{
  ...
  public clear(): void
  {
    let node: AStarWaypoint = this._nodeList as AStarWaypoint;
    let next: AStarWaypoint;
    let arc: AStarGraphArc;
    let nextArc: AStarGraphArc;

    while (node != null)
    {
      next = node.next as AStarWaypoint;
      arc  = node.arcList as AStarGraphArc;

      while (arc != null)
      {
        nextArc  = arc.next as AStarGraphArc;
   ...
   */
  public get nodeList(): AStarWaypoint
  {
    return this._nodeList as AStarWaypoint;
  }
  ...
  public fromObject(data: IAStarGraphData): void
  {
    ...
    if (!data.hasOwnProperty('edges') || !data.hasOwnProperty('waypoints')) {
      return;
    }
    ...
    {
      e = edgeList[i];
      if (!this._edges.hasOwnProperty(e.key))
      {
        v1 = this._nodes[e.from];
        v2 = this._nodes[e.to];
        w  = e.hasOwnProperty('w') ? e.w as number : this.__getWeight(v1, v2, 1);
  ...
  public addEdge(edge: IEdge): void
  {
    if (edge !== undefined)
    {
      if (edge.v1 !== undefined && edge.v1 != null && edge.v2 !== undefined && edge.v2 != null)
      {
        ...
        const cost: CostFunction | number = edge.hasOwnProperty('w') && (edge.w as number) >= 0
          ? edge.w as CostFunction | number
          : edge.hasOwnProperty('cost')
            ? edge.cost as CostFunction | number
            : 0;
