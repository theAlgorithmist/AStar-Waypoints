 ...
 */
export function createWaypoint(key: string, x: number = 0, y: number = 0, isCartesian: boolean = true, h: number = 0): AStarWaypoint
{
...
export class AStarWaypoint
{
  ...
  protected static TO_MILES: number   = 0.621371;
  protected static DEG_TO_RAD: number = 0.01745329251;  // PI/180.0;
  protected static RADIUS_KM: number  = 6378.5;         // approx avg. radius of earth in km.
  ...
  protected _data: Record<string, any>;  // optional data object associated with this waypoint - simple key-value pairs
